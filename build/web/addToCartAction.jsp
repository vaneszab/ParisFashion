<%-- 
    ...
    Created on : Jan 13, 2022, 5:10:55 PM
    Author     : ASUS
--%>
...
<%
    ...
    try{
        ...
        if(z==1)
        {
            ...
            response.sendRedirect("hometes.jsp?msg=exist");
        }
        if(z==0)
        {
            ...
            ps.executeUpdate();
            response.sendRedirect("hometes.jsp?msg=added");
        }
    }
    catch(Exception e){
        System.out.println(e);
         response.sendRedirect("hometes.jsp?msg=invalid");
        }
